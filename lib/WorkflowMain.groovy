//
// This file holds several functions specific to the main.nf workflow in the nf-core/ispcr pipeline
//
...
class WorkflowMain {
    ...
    public static String help(workflow, params, log) {
        def command = "nextflow run jimmyliu1326/isPCR -r [version] --input samplesheet.csv --primer primers.txt"
        def help_string = ''
    ...
    public static void initialise(workflow, params, log, schema_filename='nextflow_schema.json') {
        ...
        // check if input primers exists
        if ( !Utils.fileExists(params.primer) ) {
            log.error "Please provide a valid path to the primer sequences"
            System.exit(1)
        }
    }
}
